 ...
 */
final class Version20240630001332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devis (id INT NOT NULL, produit_id INT NOT NULL, user_id INT NOT NULL, mail VARCHAR(255) NOT NULL, nom_client VARCHAR(255) NOT NULL, telephone VARCHAR(20) NOT NULL, produit_prix DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id))');
